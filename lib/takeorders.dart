...
class _TakeorderPageState extends State<Takeorder> {
  ...
  List<Takeordercont> getFilteredOrders() {
    List<Takeordercont> allOrders = [
      Takeordercont(
        orderId: '123456',
        orderType: 'Type A',
        quantity: 5,
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Takeordercontdeatilspage(
...
class Takeordercontdeatilspage extends StatelessWidget {
  final String orderId;
  final String image;
  final String text;
